  ...
  return (
    <div className=" flex justify-around p-20">
      <div className=" flex flex-col items-center">
        ...
        <h1 className=" text-xl font-bold">Easy to Order</h1>
        <p className=" text-center w-[50%]  text-gray-400">
          {" "}
          Lorem, ipsum dolor sit amet consectetur adipisicing elit. Et, quas.
        </p>
      </div>
      <div className=" flex flex-col items-center">
        <div className="cl bg-[#F6F8EC]">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="45"
            height="45"
        ...
        <h1 className=" text-xl font-bold"> Fastest Delivery</h1>
        <p className=" text-center w-[50%]  text-gray-400">
          {" "}
          Lorem, ipsum dolor sit amet consectetur adipisicing elit. Et, quas.
        </p>
